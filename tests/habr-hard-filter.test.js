...
const cases = [
  ['remote anywhere', {}, 'PASS', 'allow_full_remote'],
  ['remote without location', { city: null, country: null }, 'PASS', 'allow_full_remote'],
  ...
  ['HH remote confirmed from Georgia', { source: 'headhunter', remote_geo_eligibility: 'confirmed' }, 'PASS', 'allow_full_remote'],
  ['HH remote geography unknown', { source: 'headhunter', remote_geo_eligibility: 'unknown' }, 'PASS', 'allow_full_remote'],
  ['HH remote restricted to Russia', { source: 'headhunter', remote_geo_eligibility: 'restricted' }, 'PASS', 'allow_full_remote'],
  ...
  ['missing salary', { salary_from: null, salary_to: null }, 'PASS', 'allow_full_remote'],
  ['low salary ignored', { salary_from: 40000, salary_currency: 'RUR' }, 'PASS', 'allow_full_remote'],
  ['senior handled later', { title: 'Senior AI Engineer', seniority_risk_hint: 'high' }, 'PASS', 'allow_full_remote'],
